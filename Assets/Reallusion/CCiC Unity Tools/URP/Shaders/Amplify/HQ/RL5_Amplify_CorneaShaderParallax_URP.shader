	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord228 = input.ase_texcoord6.xy * temp_cast_0 + temp_cast_1;
				...
				float2 texCoord36 = input.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord93 = input.ase_texcoord6.xy * temp_cast_4 + temp_cast_5;
				...
				float2 texCoord294 = input.ase_texcoord6.xy * temp_cast_9 + float2( 0,0 );
				...
				float2 texCoord481 = input.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
...
ASEEND*/
//CHKSM=B4BA5DA0CDA3A863F63660C0AE3FDAE35EDF45B1